...
const { imagenesDestacadas, loading, fetchImagenesDestacadas } = useMurallonImagenesDestacadas()
...
const handleEdit = (imagen) => {
    navigateTo(ROUTE_NAMES.MURALLON.EDITAR_IMAGEN_DESTACADA(imagen.id))
}
</script>
