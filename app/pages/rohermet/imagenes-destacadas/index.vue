...
const { imagenesDestacadas, loading, fetchImagenesDestacadas } = useRohermetImagenesDestacadas()
...
const handleEdit = (imagen) => {
    navigateTo(ROUTE_NAMES.ROHERMET.EDITAR_IMAGEN_DESTACADA(imagen.id))
}
</script>
