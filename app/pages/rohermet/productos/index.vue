<template>
    <DefaultSection>
        <HeadingH1>Productos Rohermet</HeadingH1>
        <ButtonPrimary :to="ROUTE_NAMES.ROHERMET.CREAR_PRODUCTO">
...
const { productos, loading, fetchProductos, deleteProducto } = useRohermetProductos()
...
const handleEdit = (producto) => {
    navigateTo(ROUTE_NAMES.ROHERMET.EDITAR_PRODUCTO(producto.id))
}
