<template>
    <DefaultSection>
        <NuxtLink :to="ROUTE_NAMES.WATERPLAST.CATEGORIAS"
        ...
        <div v-else-if="!currentCategoria" class="text-center py-12">
            ...
            <ButtonPrimary :to="ROUTE_NAMES.WATERPLAST.CATEGORIAS" class="mt-4">
                Volver a categorías
            </ButtonPrimary>
        </div>
...
const handleSubmit = async (formData) => {
    try {
        ...
        navigateTo(ROUTE_NAMES.WATERPLAST.CATEGORIAS)
    } catch (err) {
